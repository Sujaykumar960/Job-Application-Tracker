...
class DatabaseManager:
    ...
    async def create_indexes(cls) -> None:
        ...
        try:
            ...
            # 11. Resumes Collection
            await cls.db.resumes.create_index([("userId", ASCENDING)])
            await cls.db.resumes.create_index([("userId", ASCENDING), ("isPrimary", ASCENDING)])
            await cls.db.resume_analyses.create_index([("userId", ASCENDING)])
            await cls.db.resume_analyses.create_index([("resumeId", ASCENDING)])
