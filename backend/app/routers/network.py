...
async def send_connection_request(
    ...
    repo = ConnectionRepository(db)
    requester_id = user["id"] if user else "usr_guest"
...
async def accept_connection_request(
    ...
    repo = ConnectionRepository(db)
    receiver_id = user["id"] if user else "usr_guest"
...
async def remove_connection(
    ...
    repo = ConnectionRepository(db)
    current_uid = user["id"] if user else "usr_guest"
...
async def follow_user(
    ...
    repo = ConnectionRepository(db)
    follower_id = user["id"] if user else "usr_guest"
